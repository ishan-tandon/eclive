...
pole = input("Pole:\t")
pole_fn = fullname_extractor(pole)
...
trc = results_racecodes(racecode = rc, year = year, round_no = round_no, track_png = trackpng, country = country, race_name = racename, sprint=2)
trc.save()
